...
export const translations = {
  es: {
      ...
      categories: [
        {
          ...
          techs: [
            ...
            { name: "Vue", icon: "devicon-vuejs-plain", color: "#42B883" },
        ...
        },
        {
          ...
          techs: [
            ...
            { name: "Expo", icon: "devicon-xcode-plain", color: "#000020" },
          ],
        },
        {
          name: "Base de Datos",
        ...
        },
        {
          ...
          techs: [
            ...
            { name: "GitHub Actions", icon: "devicon-github-original", color: "#ffffff" },
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "Nexora transformó completamente nuestra operación. En menos de 3 meses teníamos un sistema que automáticamente procesa miles de transacciones diarias sin errores. El equipo estuvo con nosotros en cada paso.",
          name: "Carlos Mendoza",
          role: "CEO",
          company: "NovaPay",
          initials: "CM",
        ...
        {
          quote: "Lo que más nos sorprendió fue la calidad del código y la documentación. Meses después del lanzamiento seguimos escalando sin problemas. MediTrack es hoy la columna vertebral de nuestra operación clínica.",
          name: "Ana Rodríguez",
          role: "CTO",
          company: "MediTrack",
          initials: "AR",
        ...
        {
          quote: "Trabajar con Nexora fue una experiencia diferente. No solo entregaron el producto, sino que nos ayudaron a pensar mejor nuestro negocio. LogiFlow redujo nuestros costos operativos en un 40% en el primer trimestre.",
          name: "Javier Torres",
  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "Nexora completely transformed our operation. In less than 3 months we had a system that automatically processes thousands of daily transactions without errors. The team was with us every step of the way.",
          name: "Carlos Mendoza",
          role: "CEO",
          company: "NovaPay",
          initials: "CM",
        ...
        {
          quote: "What surprised us most was the code quality and documentation. Months after launch we're still scaling without issues. MediTrack is today the backbone of our clinical operation.",
          name: "Ana Rodríguez",
          role: "CTO",
          company: "MediTrack",
          initials: "AR",
        ...
        {
          quote: "Working with Nexora was a different experience. They didn't just deliver the product, they helped us think better about our business. LogiFlow reduced our operational costs by 40% in the first quarter.",
          name: "Javier Torres",
